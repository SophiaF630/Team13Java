...
public class StudentController {
	...
	public ModelAndView listAllSelectedCourse() {
		...
		ArrayList<Studentcourse> studentcourse_enrolled = sService.findAllStudentCourseByStatus("Enrolled", studentId);
		ArrayList<Studentcourse> studentcourse_pending = sService.findAllStudentCourseByStatus("Pending", studentId);
		ArrayList<Studentcourse> studentcourse_cancelled = sService.findAllStudentCourseByStatus("Cancelled", studentId);
